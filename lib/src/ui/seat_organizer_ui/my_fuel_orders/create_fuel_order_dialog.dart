...
class CreateFuelOrderDialog extends StatefulWidget {
  const CreateFuelOrderDialog({Key? key})
      : super(key: key);

  @override
  State<CreateFuelOrderDialog> createState() => _CreateFuelOrderDialogState();
}

class _CreateFuelOrderDialogState extends State<CreateFuelOrderDialog> {
  ...
  void _saveResource(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      var newFuelOrder = FuelOrder(
          orderQuantityInLitres: int.tryParse(_amountInLitresController.text),
      ...
      var result = await GetIt.I<MainApiProvider>().createFuelOrder(newFuelOrder);
